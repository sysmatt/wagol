...
export class Universe {
     ...
     */
    pixels_ptr() {
        const ret = wasm.universe_pixels_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} width
     ...
     */
    scatter_cells(x, y, radius, density) {
        wasm.universe_scatter_cells(this.__wbg_ptr, x, y, radius, density);
    }
    tick() {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wagol_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
